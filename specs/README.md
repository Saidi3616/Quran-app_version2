...
er uenige, er det koden, der er forkert, eller også skal specifikationen opdateres _først_.
...
| 2. Teknisk plan  | [`001-tekst-og-navigation/plan.md`](001-tekst-og-navigation/plan.md)   | **Hvordan** bygger vi det? (sprog, framework, datakilder)          | ✅ Udkast        |
| 3. Opgaveliste   | [`001-tekst-og-navigation/tasks.md`](001-tekst-og-navigation/tasks.md) | Hvilke små, testbare skridt skal vi tage, og i hvilken rækkefølge? | ✅ 29 opgaver    |
