...
Så bliver fremhævning, "gentag vers" og "gentag udsnit" enkle at lave: afspil fil _n_, og gå
videre til _n+1_. Brugeren downloader kun de suraer, han eller hun selv vælger.

**Tjekliste før fase 2:**

1. Læs og citér vilkårene direkte fra EveryAyah og Al Quran Cloud.
2. Bekræft, at _brugerens egen download til offline brug_ er tilladt.
